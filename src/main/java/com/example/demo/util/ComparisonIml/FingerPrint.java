 ...
 *
 */
public final class FingerPrint implements ImageComparisonStrategies {
    /**
    ...
    public byte[] getCompactedHashValue(BufferedImage src){
        return compact(hashValue(src));
    }
...
//    }
    ...
    public float getResult(byte[] f1,byte[] f2){
        return compareCompact(f1,f2);
    }
}